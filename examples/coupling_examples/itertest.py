"""
Example of a user specified wind farm layout with differnt number of calculate_induction iterations
Returns: Power summary, velocity at each of the turbines in each field, horizontal velocity plots of each field.
"""
...
itertest = [3,5] # will run tests using each iteration (only accepts length of two)
