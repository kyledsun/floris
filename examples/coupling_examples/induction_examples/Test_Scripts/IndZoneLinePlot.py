...
if Readouts:
    print('=================================================')
    print('Percent Reduction Due to Blockage')
    print('-------------------------------------------------')
    print('Loc | ', end='')
    ...
    print('-8D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == -8*D].u_ind/U0*100),end='')
    print()
    print('-5D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == -5*D].u_ind/U0*100),end='')
    print()
    print('-3D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == -3*D].u_ind/U0*100),end='')
    print()
    print('-2D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == -2*D].u_ind/U0*100),end='')
    print()
    print('-1D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == -1*D].u_ind/U0*100),end='')
    print()
    print(' 1D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == 1*D].u_ind/U0*100),end='')
    ...
    print('-8D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == -8*D].u/U0*100),end='')
    print()
    print('-5D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == -5*D].u/U0*100),end='')
    print()
    print('-3D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == -3*D].u/U0*100),end='')
    print()
    print('-2D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == -2*D].u/U0*100),end='')
    print()
    print('-1D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == -1*D].u/U0*100),end='')
    print()
    print(' 1D: ', end='')
    for i in range(len(m)):
        print('\t%.2f%%' %(line[i].loc[line[i].x1 == 1*D].u/U0*100),end='')
