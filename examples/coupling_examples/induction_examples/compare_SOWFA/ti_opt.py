...
"""
Optimizes turbulence intensity with given windspeed to match FLORIS and SOWFA turbine powers
"""
...
fi.reinitialize_flow_field(layout_array=[layout_x,layout_y], wind_speed=8.18)
...
print('---------------------------------------------------')
print('TI: ', round(plant.x[0]/multfact,4))
