...
import numpy as np
# --- Local
from floris.simulation.wake_vortex.VortexCylinder import vc_tang_u
from floris.simulation.wake_vortex.WindFarm       import windfarm_gridlayout_CTconst
...
def layout_ct_with_ground(test=False):
    ...
    ax.grid(b=True,axis='both',linestyle='--',linewidth=0.5,color='k')
    ax.legend()
